...
function StarRating($container) {
  ...
  for (let i = 0; i < starNum; i++) {
    ...
    // 이벤트 핸들러가 될 mouseoverHandler 정의
    ...
    $container
      .querySelectorAll(".bx")
      [i].addEventListener("mouseover", mouseoverHandler);

    // 이벤트 핸들러가 될 mouseoutHandler 정의
    ...
    $container
      .querySelectorAll(".bx")
      [i].addEventListener("mouseout", mouseoutHandler);

    // 이벤트 핸들러가 될 clickHandler 정의
